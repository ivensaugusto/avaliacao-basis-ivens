...
public class DisciplinaDetalhadaMapperImpl implements DisciplinaDetalhadaMapper {
    ...
    @Override
    public List<Disciplina> toEntity(List<DisciplinaDetalhadaDTO> arg0) {
        if ( arg0 == null ) {
            return null;
        }

        List<Disciplina> list = new ArrayList<Disciplina>( arg0.size() );
        for ( DisciplinaDetalhadaDTO disciplinaDetalhadaDTO : arg0 ) {
    ...
    @Override
    public List<DisciplinaDetalhadaDTO> toDto(List<Disciplina> arg0) {
        if ( arg0 == null ) {
            return null;
        }

        List<DisciplinaDetalhadaDTO> list = new ArrayList<DisciplinaDetalhadaDTO>( arg0.size() );
