...
public class AlunoGravarMapperImpl implements AlunoGravarMapper {
    ...
    @Override
    public List<Aluno> toEntity(List<AlunoGravarDTO> arg0) {
        if ( arg0 == null ) {
            return null;
        }

        List<Aluno> list = new ArrayList<Aluno>( arg0.size() );
        for ( AlunoGravarDTO alunoGravarDTO : arg0 ) {
    ...
    @Override
    public List<AlunoGravarDTO> toDto(List<Aluno> arg0) {
        if ( arg0 == null ) {
            return null;
        }

        List<AlunoGravarDTO> list = new ArrayList<AlunoGravarDTO>( arg0.size() );
