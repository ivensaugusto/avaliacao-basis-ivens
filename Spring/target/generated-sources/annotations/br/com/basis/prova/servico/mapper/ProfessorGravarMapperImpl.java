...
public class ProfessorGravarMapperImpl implements ProfessorGravarMapper {
    ...
    @Override
    public List<Professor> toEntity(List<ProfessorGravarDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<Professor> list = new ArrayList<Professor>( dtoList.size() );
        for ( ProfessorGravarDTO professorGravarDTO : dtoList ) {
    ...
    @Override
    public List<ProfessorGravarDTO> toDto(List<Professor> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<ProfessorGravarDTO> list = new ArrayList<ProfessorGravarDTO>( entityList.size() );
